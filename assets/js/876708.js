...
zargetMain = zargetMain || (function () {
    ...
    var Zarget = (function () {
        ...
        zarget.serverinfo = {
            ...
            sessionDataSendUrl: "https://src.freshmarketer.com/sr",
            eventDataSendUrl: "https://src.freshmarketer.com/mas",
            formTrackingUrl: "https://src.freshmarketer.com/mas",
            croDataSendUrl: "https://src.freshmarketer.com/cro",
            ...
            visitor: function (c) {
                ...
                try {
                    var cookie = document.cookie || "",
                        usertype;
                    usertype = cookie.indexOf("zarget_user_id=") !== -1;
    ...
    var ZargetData = {
        IS_BUNDLE_ACCOUNT: false,
        excludes: {},
        mas_tracking_info: {
            enabled: false
        },
        experiments: {
            "4154535053514A425F535450445E4C575859585F57": {
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                lid: "BQPXSVX",
                ...
                selectorExcludes: {},
                excludeUrls: [],
                is_predictive_support_enabled: false,
                url: "https://help.clippingpathindia.com/article/107-how-to-place-a-new-order-based-on-a-previous-order",
                personalization: 0,
                schedule: 1,
                urls: [{
                    match: "simple",
                ...
                mask_keystroke: 1,
                variations: [1019172],
                isCrossDomainExperiment: false,
                createdTime: 1546023802617,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A425F535450445E4C575859585F57",
                experimentName: "SUP0047 New order based on prev one",
                traffic: 100,
                goals: [1019174]
            },
            "4154535053514A4A5E5B5458464C575859585F57": {
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                lid: "JPXX[T",
                ...
                excludeUrls: [],
                is_predictive_support_enabled: false,
                url: "https://help.clippingpathindia.com/article/111-how-to-use-brickftp-to-upload-download-images-in-the-customer-portal",
                personalization: 0,
                schedule: 0,
                urls: [{
                    match: "simple",
                ...
                variations: [919996],
                isCrossDomainExperiment: false,
                createdTime: 1539442181192,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A4A5E5B5458464C575859585F57",
                experimentName: "SUP0048 How to use BrickFTP",
                traffic: 100,
                goals: [920600]
            },
            "4154535053514A425B505D594A5F4C575859585F57": {
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                lid: "BUSQZXY",
                ...
                excludeUrls: [],
                is_predictive_support_enabled: false,
                url: "https://clippingpathindia.com/blogs/tips/outsourcing-photo-editing-how-choose",
                personalization: 0,
                schedule: 1,
                urls: [{
                    match: "simple",
                ...
                variations: [1420891],
                isCrossDomainExperiment: false,
                createdTime: 1568637441567,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A425B505D594A5F4C575859585F57",
                experimentName: "BLG0018 Choose outsourced resource",
                traffic: 100,
                goals: [1420893]
            },
            "4154535053514A425F535457435F4C575859585F57": {
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                lid: "BQPXTQY",
                ...
                excludeUrls: [],
                is_predictive_support_enabled: false,
                url: "https://help.clippingpathindia.com/",
                personalization: 0,
                schedule: 1,
                urls: [{
                    match: "simple",
                ...
                variations: [1019601],
                isCrossDomainExperiment: false,
                createdTime: 1546023719474,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A425F535457435F4C575859585F57",
                experimentName: "SUP#001 Support center homepage",
                traffic: 100,
                goals: [1019603]
            },
            "4154535053514A425A505852475D4C575859585F57": {
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                lid: "BTSTQU[",
                ...
                excludeUrls: [],
                is_predictive_support_enabled: false,
                url: "https://clippingpathindia.com/blogs/tips/beginners-guide-photoshop-cs6-tools-part-1",
                personalization: 0,
                schedule: 1,
                urls: [{
                    match: "simple",
                ...
                variations: [1525343],
                isCrossDomainExperiment: false,
                createdTime: 1579536025279,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A425A505852475D4C575859585F57",
                experimentName: "BLG0107-2 Guide to Photoshop Tools",
                traffic: 100,
                goals: [1525345]
            },
            "4154535053514A4B57535551424C575859585F57": {
                formid: "",
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                ...
                selectorExcludes: {},
                excludeUrls: [],
                formselector: ".price-estimator-form",
                is_predictive_support_enabled: false,
                url: "https://clippingpathindia.com/pages/pricing",
                personalization: 0,
                schedule: 0,
                urls: [{
                    match: "simple",
                ...
                mask_keystroke: 1,
                isCrossDomainExperiment: false,
                createdTime: 1536787739121,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A4B57535551424C575859585F57",
                experimentName: "Pricing form",
                traffic: 100,
                goals: [881808]
            },
            "4154535053514A4B57535959464C575859585F57": {
                formid: "",
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                ...
                selectorExcludes: {},
                excludeUrls: [],
                formselector: ".quote_form",
                is_predictive_support_enabled: false,
                url: "https://clippingpathindia.com/a/portal/quotations/new/",
                personalization: 0,
                schedule: 0,
                urls: [{
                    match: "simple",
                ...
                mask_keystroke: 1,
                isCrossDomainExperiment: false,
                createdTime: 1536787498768,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A4B57535959464C575859585F57",
                experimentName: "Quote request form",
                traffic: 100,
                goals: [881904]
            },
            "4154535053514A425F505E594B5F4C575859585F57": {
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                lid: "BQSRZYY",
                ...
                excludeUrls: [],
                is_predictive_support_enabled: false,
                url: "https://clippingpathindia.com/pages/vector-conversion",
                personalization: 0,
                schedule: 1,
                urls: [{
                    match: "simple",
                ...
                variations: [1023881],
                isCrossDomainExperiment: false,
                createdTime: 1546907609032,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A425F505E594B5F4C575859585F57",
                experimentName: "WEB0019 Vector conversion service",
                traffic: 100,
                goals: [1023883]
            },
            "4154535053514A425D505F56475A4C575859585F57": {
                heatmap: 1,
                queryparam: false,
                activationMode: 1,
                lid: "BSSSUU\\",
                ...
                excludeUrls: [],
                is_predictive_support_enabled: false,
                url: "https://clippingpathindia.com/blogs/tips/how-much-charge-product-photography-outsource-editing",
                personalization: 0,
                schedule: 1,
                urls: [{
                    match: "simple",
                ...
                variations: [1222746],
                isCrossDomainExperiment: false,
                createdTime: 1559737416905,
                ga: {
                    dimensionId: "1",
                    tracker: "",
                    integrate: false
                },
                id: "4154535053514A425D505F56475A4C575859585F57",
                experimentName: "BLG0001 Charge for outsourced edits",
                traffic: 100,
                goals: [1222748]
            }
        },
        ...
        polls: {},
        "domain-url": "alxshhn.freshmarketer.com",
        product_name: "Freshmarketer",
        samplePercentage: 100,
        "fwdomain-url": "alxshhn.freshworks.com",
        audiences: {
            "1": {}
        },
        goals: {
            ...
            "881808": {
                urls: [{
                    condition: 6,
                    url: "clippingpathindia.com/a/portal/quotations/new/"
                }],
                id: 881808,
                type: 1
            },
            ...
            "881904": {
                urls: [{
                    condition: 6,
                    url: "clippingpathindia.com/a/portal/quotations/upload_samples"
                }],
                id: 881904,
                type: 1
            }
        },
        orgidhash: "42575253525751415F525E57434C5D5A5D5E5E5F"
    };
                        ...
                        if (arguments[0] === "zg_setCutomAttribute") {
                            ...
                            if (arguments[0] === "fm_form_tracking") {
                                try {
                                    var d = arguments[1],
                                        u = arguments[2];
                                    if (d && u && typeof d === "string" && typeof u === "object") {
        ...
        function startAbPreview() {
            try {
                ...
                if (variationCounter < 4 && !prevModeVariation) {
                    ...
                    if (prevModeVariation) {
                        try {
                            var expHashId = prevModeExperiment.id;
                            if (expHashId) {
                                window.zarget$.ajax({
            ...
            fnSendData: function () {
                ...
                if (next === 1) {
                    ...
                    if (modelObj[ansIndex + 1]) {
                        ...
                        window.zarget$(document).unbind("mouseout")
                    }
                } else {
                    if (next === 2) {
                        Zarget.updatePollData(poll.id, "completed", true, poll.trigger);
    ...
    (function (FMCore, FMData) {
        ...
        var isPageVisitTrackingEnabled = (function () {
            ...
            var curDomain = trimWwwAndTrailingSlash(FMCore.parseURL(FMCore.getURL()).authority).toLowerCase();
            if (!domains) {
                return false
            }
        ...
        (function (a) {
            var EventStore = (function () {
                function EventStore() {
                    this.priorityEvents = [eventConst.PAGE_VISIT, eventConst.WEB_FORM];
                    this.batchEvents = [];
                    this.events = []
                }
    ...
    (function (Zarget, ZargetData) {
        ...
        var FORMFIELDS = "input,select,button,textarea,password";
        var EXCLUDE_ATTRIBUTE = "fm-fa-exclude";
        var FORMEVENTS = "change.zarget focus.zarget blur.zarget keyup.zarget click.zarget";
        var MAX_TIMEOUT = 15 * 1000,
            INTERVAL = 1000;
        var ZARGET_FORM = "zg_form";
        var METAKEYS = [16, 17, 18, 91];
        var pendingForms = [];
        var requestAlreadyGoing = false;
        if (!window.zarget$) {
            window.zarget$ = jQuery.noConflict(true);
            window.$ = window.$ || window.jQuery || window.zarget$;
            window.zarget$ = window.zarget$ || window.jQuery
        }
        window.FMFormApi = window.ZargetFormAPI = window.ZargetFormAPI || [];
        var ZargetForm = function (experiment) {
            this.experiment = experiment;
            this.formname = experiment.formname;
            this.formid = experiment.formid;
            this.formselector = experiment.formselector;
            if (this.isVisitorConverted()) {
                Zarget.log("@@@ Visitor is already converted @@@@");
                return
            }
            this.form = window.zarget$("form[name='" + this.formname + "']");
            if ((!this.form || !this.form.length) && this.formid) {
                var tagName = "FORM";
                this.form = window.zarget$(tagName + "#" + this.formid)
            }
            if ((!this.form || !this.form.length) && this.formselector) {
                this.form = window.zarget$(this.formselector)
            }
            if (!this.form || this.form.length === 0) {
                Zarget.log("Form is not loaded in the document. Form: ", this.formname, "id: ", this.formid, ", Going to retry..");
                this.retry();
                return
            }
            this.init()
        };
        ZargetForm.prototype = {
            isBlank: function (field) {
                var selectFields, type;
                if (!field) {
                    return
                }
                selectFields = ["radio", "checkbox"];
            ...
            isRadioBtnBlank: function (name, id) {
                if (!name && !id) {
                    return
                }
                var ele, i, l;
                if (name) {
                    ele = this.form.find("[name='" + name + "']")
                } else {
                    if (id) {
                        ele = this.form.find("[id='" + id + "']")
                    }
                }
            ...
            getFormFields: function (asObj) {
                if (!this.form) {
                    return []
                }
                var exclude, fields = asObj ? {} : [],
                    radioAndCheckboxes = [],
                    i, l, e, n, type, id, name, b, elements;
                exclude = ["hidden", "submit", "button", "reset", "radio", "checkbox"];
                elements = this.form.find(FORMFIELDS);
                for (i = 0, l = elements.length, e; i < l; i++) {
                    e = elements[i];
                    type = e.getAttribute("type") && e.getAttribute("type").toLowerCase();
                    n = e.getAttribute("name");
                    id = e.getAttribute("id");
                    name = n || id;
                    if (isFieldExcluded(e)) {
                        continue
                    }
                    if (exclude.indexOf(type) === -1 && name && window.zarget$(e).is(":visible")) {
                        b = this.isBlank(e);
                        if (asObj) {
                            fields[n] = b
                        } else {
                    ...
                    if (name && window.zarget$(e).is(":visible") && (type === "radio" || type === "checkbox") && !this.contains(radioAndCheckboxes, n, id)) {
                ...
                for (i = 0, l = radioAndCheckboxes.length, e, n; i < l; i++) {
                    e = radioAndCheckboxes[i];
                    n = e.n || e.id;
                    b = this.isRadioBtnBlank(e.n, e.id);
                    if (asObj) {
                        fields[n] = b
                    } else {
                        fields.push({
            ...
            rememberVisitor: function () {
                var experiment = this.experiment,
                    ...
                    vobj;
                vobj = typeof visitorinfo === "object" ? visitorinfo : {};
                if (!vobj.hasOwnProperty(experiment.lid)) {
                    vobj[experiment.lid] = visitorState;
                    Zarget.setCookie(Zarget.visitorInfoCookie, encodeURIComponent(Zarget.stringifyJSON(vobj)), age)
                }
            },
            isAlreadyVisitedUser: function () {
                var experiment = this.experiment,
                    visitorInfo = Zarget.getVisitorInfo();
                return visitorInfo && visitorInfo.hasOwnProperty(experiment.lid)
            },
            isVisitorConverted: function () {
                var experiment = this.experiment,
                    visitorInfo = Zarget.getVisitorInfo();
                return visitorInfo && visitorInfo[experiment.lid] === "1"
            },
            init: function () {
                var self = this;
                if (!this.isAlreadyVisitedUser()) {
                    this.sendMessage(this.getFormFields())
                }
                this.rememberVisitor();
                this.form.off(FORMEVENTS, FORMFIELDS);
                this.form.on(FORMEVENTS, FORMFIELDS, function (e) {
                    self.handleFormActions.apply(self, [e, window.zarget$(this)])
                });
                window.addEventListener("beforeunload", function () {
                    var fieldname = self.formstats.lastActive;
                    var fieldele = self.formstats.lastActiveEle;
                    window.localStorage.zargetField = "before unload " + fieldname;
                    if (fieldname) {
                        self.sendStats(null, fieldele, fieldname)
                    }
                });
                this.formstats = {}
            },
            retry: function () {
                ...
                function sch() {
                    var time = (new Date()).getTime(),
                        form;
                    if ((time - self.timerStart) >= MAX_TIMEOUT) {
                        Zarget.log("Retry timeout, form : " + self.formname + "," + self.formid + " is not loaded.");
                        window.clearTimeout(timerId);
                        return
                    }
                    form = window.zarget$("form[name='" + self.formname + "'], form#" + self.formid);
                    if (form.length === 0) {
                        timerId = window.setTimeout(sch, INTERVAL);
                        return
                    }
                    self.init()
                }
            ...
            handleFormActions: function (evt, ele) {
                if (isFieldExcludedJquery(ele)) {
                    return
                }
                switch (evt.type) {
                    case "focusin":
            ...
            click: function (evt, ele) {
                ...
                this.form.off("click.zarget", FORMFIELDS)
            },
            keyup: function (evt, ele) {
                var code = evt.which || evt.keyCode,
                    type = ele && ele.get(0).type,
                    time = (new Date()).getTime(),
                    fieldname, fieldstats, formstats = this.formstats,
                    fieldval, blank;
                if (!this.formstats.engaged) {
                    if (METAKEYS.indexOf(code) === -1 && !evt.isCtrlKey) {
                        this.formstats.engaged = true;
                ...
                if (!formstats.engaged || code === 9 || type === "submit" || type === "button") {
                    return
                }
                fieldname = ele.attr("name") || ele.attr("id");
                if (!fieldname) {
                    return
                }
                fieldstats = formstats[fieldname] || {};
                fieldval = ele.val();
                blank = fieldstats.blank;
                fieldstats.blank = !!(!fieldval || fieldval.trim().length === 0);
                if (blank !== fieldstats.blank) {
                    this.sendMessage(null, {
                        fields: [{
                            n: fieldname,
                            b: fieldstats.blank
                ...
                if (fieldstats.hesitationtime || ele.val().length < 1) {
                    return
                }
                fieldstats.hesitationtime = time - fieldstats.start
            },
            focus: function (evt, ele) {
                ...
                formstats.blankfields = this.getFormFields(true);
                formstats[fieldname] = formstats[fieldname] || {};
                fieldstats = formstats[fieldname];
                if (fieldstats.arfc) {
                    fieldstats.arfc = false
                }
                formstats.lastActive = fieldname;
                formstats.lastActiveEle = ele;
                if (!(type === "submit" || type === "button") && formstats.engaged) {
                    this.sendMessage(null, {
                        d: fieldname,
                        t: 0
                    })
                }
                fieldstats.start = startTime;
                if (formstats.engaged && fieldstats.isrefocus) {
                    fieldstats.refocus = fieldstats.refocus ? fieldstats.refocus + 1 : 1
                }
                if (formstats.engaged && !fieldstats.isrefocus) {
                    fieldstats.isrefocus = true
                }
            },
            focusout: function (evt, ele) {
                var fieldname = ele.attr("name") || ele.attr("id");
                if (!fieldname || !this.formstats.engaged) {
                    return
                }
                if (!this.formstats[fieldname]) {
                    return
                }
                this.sendStats(evt, ele, fieldname)
            },
            diffBlankFields: function (old, latest, ignore) {
                var k, changed;
                if (!old || !latest) {
                    return
                }
                ...
                changed = [];
                for (k in old) {
                    if (ignore.indexOf(k) === -1 && old[k] !== latest[k]) {
                        changed.push({
                            n: k,
                            b: latest[k]
                        })
            ...
            sendStats: function (evt, ele, fieldname) {
                var end = (new Date()).getTime(),
                    startTime, timespent, fieldstats, blankFields, formdata, type, formstats = this.formstats;
                if (!fieldname || !formstats.engaged) {
                    return
                }
                startTime = this.formstats[fieldname].start || end;
                timespent = end - startTime;
                fieldstats = this.formstats[fieldname];
                fieldstats.timespent = fieldstats.timespent ? fieldstats.timespent + timespent : timespent;
                this.formstats.timespent = this.formstats.timespent ? this.formstats.timespent + timespent : timespent;
                fieldstats.start = null;
                fieldstats.end = null;
                fieldstats.arfc = false;
                blankFields = this.diffBlankFields(formstats.blankfields, this.getFormFields(true));
                delete formstats.blankfields;
                formdata = {
                    t: this.formstats.timespent
                };
                type = ele && ele.get(0).type;
                if (!(type === "submit" || type === "button")) {
                    ...
                    formdata.fields = [{
                        n: fieldname,
                        t: fieldstats.timespent || 0,
                        r: fieldstats.refocus || 0,
                        e: fieldstats.refill || 0,
                        ht: fieldstats.hesitationtime || 0,
                        b: fieldstats.blank
                    }];
                    if (blankFields && blankFields.length) {
                        formdata.fields = formdata.fields.concat(blankFields)
                    }
                    formdata.d = this.formstats.lastActive
                }
                this.formstats.timespent = 0;
                this.formstats.lastActive = null;
                this.formstats[fieldname] = {
                    hesitationtime: fieldstats.hesitationtime,
                    blank: fieldstats.blank,
                    isedit: fieldstats.isedit,
                    isrefocus: fieldstats.isrefocus
                };
                this.sendMessage(null, formdata)
            },
            change: function (evt, ele) {
                var fieldname, fieldstats, blank, type;
                fieldname = ele.attr("name") || ele.attr("id");
                if (!this.formstats[fieldname]) {
                    this.formstats[fieldname] = {}
                }
                ...
                blank = fieldstats.blank;
                if (type === "checkbox") {
                    fieldstats.blank = this.isRadioBtnBlank(ele.attr("name"), ele.attr("id"))
                } else {
                    if (type === "radio") {
                        fieldstats.blank = !ele.is(":checked")
                    } else {
                        fieldstats.blank = !ele.val().length
                    }
                }
                if (blank !== fieldstats.blank) {
                    this.sendMessage(null, {
                ...
                if (!fieldstats || fieldstats.arfc) {
                    return
                }
                fieldstats.arfc = true;
                if (fieldstats.isedit) {
                    fieldstats.refill = fieldstats.refill ? fieldstats.refill + 1 : 1
                }
                if (!fieldstats.isedit) {
                    fieldstats.isedit = true
                }
                if (!fieldstats.hesitationtime) {
                    fieldstats.hesitationtime = (new Date()).getTime() - fieldstats.start
                }
            },
            sendMessage: function (formfields, formdata) {
                var experiment = this.experiment,
                    expid = experiment.id,
                    r, uid, url, referrer, msg, today, nowUTC, params;
                url = encodeURIComponent(document.URL);
                referrer = document.referrer;
                if (experiment.isCrossDomainExperiment) {
                    uid = window.zarget_masteruserid
                ...
                msg = new Zarget.Message(Zarget.MessageType.ADDVISITOR);
                today = new Date();
                nowUTC = today.getTime() + (today.getTimezoneOffset() * 60000);
                params = {
                    eid: expid,
                    uid: uid,
                    r: r,
                ...
                if (formdata) {
                    params.formdata = encodeURIComponent(Zarget.stringifyJSON(formdata))
                }
                if (formfields) {
                    params.formfields = encodeURIComponent(Zarget.stringifyJSON(formfields));
                    params.op = "create"
                }
                msg.setParam(params);
                msg = Zarget.checkCustomAttr(msg);
        ...
        function isFieldExcluded(ele) {
            return ele && (ele.getAttribute(EXCLUDE_ATTRIBUTE) === "" || ele.getAttribute(EXCLUDE_ATTRIBUTE) === "true")
        }

        function isFieldExcludedJquery(ele) {
            return ele && (ele.attr(EXCLUDE_ATTRIBUTE) === "" || ele.attr(EXCLUDE_ATTRIBUTE) === "true")
        }

        function filterCustomGoals(goals, event) {
            if (!goals) {
                return
            }
            var filtered = [],
                i, goal, l;
            for (i = 0, goal, l = goals.length; i < l; i++) {
                goal = goals[i];
                if (ZargetData.goals.hasOwnProperty(goal) && ZargetData.goals[goal].type === 7 && ZargetData.goals[goal].event === event) {
                    filtered.push(ZargetData.goals[goal])
                }
            }
            return filtered
        }

        function sendGoal(expid, gid) {
            var r, uid, msg, url, experiment, lang = Zarget.getUserLanguage(),
                loadt = Zarget.getPageLoadTime(),
                res = Zarget.getScreenResolution(),
                referrer;
            experiment = ZargetData.experiments[expid];
            if (!experiment) {
                return
            }
            url = encodeURIComponent(document.URL);
            ...
            var goalInfo = Zarget.getGoalInfo();
            rc = !goalInfo ? false : (goalInfo[expid] ? (goalInfo[expid].indexOf(gid) > -1 ? true : false) : false);
            Zarget.rememberGoal(experiment, gid);
            msg = new Zarget.Message(Zarget.MessageType.ADDGOAL);
            var today = new Date();
            var nowUTC = today.getTime() + (today.getTimezoneOffset() * 60000);
            msg.setParam({
        ...
        function markAsCompleted(experiment) {
            if (!experiment) {
                return
            }
            var visitorState = "1",
        ...
        function handleCustomEvent(goalname) {
            var visitorInfo = Zarget.getVisitorInfo(),
                eid, lid, goals, exp, experiments = ZargetData.experiments,
                matched, i, l;
            if (!visitorInfo || !goalname) {
                return
            }
            for (lid in visitorInfo) {
                exp = Zarget.isLidExists(experiments, lid);
                if (!exp || (exp && exp.type !== 7)) {
                    continue
                }
                eid = exp.id;
                goals = exp.goals;
                ...
                matched = filterCustomGoals(goals, goalname);
                for (i = 0, l = matched.length; i < l; i++) {
                    markAsCompleted(exp);
                    sendGoal(eid, matched[i].id)
                }
            }
        }

        function callPendingForms() {
            for (i = 0, l = pendingForms.length; i < l; i++) {
                new ZargetForm(pendingForms[i]);
                pendingForms.splice(i, 1)
            }
            window.ZargetFormAPI.push = function () {
                Array.prototype.push.apply(this, arguments);
                try {
                    if (arguments[0] === ZARGET_FORM) {
                        handleCustomEvent(arguments[1])
                    }
                } catch (e) {
                    Zarget.log("Error while tracking virtual pages.", e)
                }
        ...
        function start() {
            ...
            for (e in ZargetData.experiments) {
                experiment = ZargetData.experiments[e];
                if (experiment.type === 7 && (Zarget.isExperimentURLMatches(experiment) || (trimWwwAndHttps(experiment.url) === trimWwwAndHttps(document.URL)))) {
                    if (experiment.isCrossDomainExperiment) {
                        pendingForms.push(experiment);
                        var variation = {};
                        variation.id = 0;
                        Zarget.getVariationForExperimentAndUser(experiment.id, variation, callPendingForms, null);
                        return
                    }
                    new ZargetForm(experiment)
                }
            }
            window.ZargetFormAPI.push = function () {
                Array.prototype.push.apply(this, arguments);
        ...
        window.zarget$(document).ready(function () {
            if (ZargetData) {
                start();
                window.ZargetUrlChangeTrigger.register(start)
            }
        });
        window.ZargetForm = ZargetForm
    }(Zarget, ZargetData));
    return 1
}());